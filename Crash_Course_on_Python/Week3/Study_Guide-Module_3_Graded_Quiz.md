...
It is time to prepare for the Module 3 Graded Quiz. Please review the following items from this module before beginning the Module 3 Graded Quiz. If you would like to refresh your memory on these materials, please also revisit the [while Loop Study Guide](../Week3/Study_Guide-while_Loops.md) and the [for Loop Study Guide](../Week3/Study_Guide-for_Loops.md) located before the Practice Quizzes in Module 3. You will not be tested on the Recursion lesson content, which is optional in this module.
