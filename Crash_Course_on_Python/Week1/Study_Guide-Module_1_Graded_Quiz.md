...
It is time to prepare for your first graded quiz! Please review the following items from this module before beginning the Module 1 Graded Quiz. If you would like to refresh your memory on these materials, please revisit the Study Guides located before each Practice  Quiz in Module 1: [Study Guide: Introduction to Programming](../Week1/Study_Guide-Introduction_to_Programming.md), Study [Guide: Introduction to Python](../Week1/Study_Guide-Introduction_to_Python.md), and [Study Guide: First Programming Concepts](../Week1/Study_Guide-First_Programming_Concepts.md).  
